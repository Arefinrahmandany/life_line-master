<div class="py-2 m-auto">
    <yt-icon class="style-scope ytd-background-promo-renderer">
        <svg viewBox="0 0 230 130" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon" style="pointer-events: none; display: block; width: 250px; height: 100%;margin: auto;">
            <g viewBox="0 0 230 130" class="style-scope yt-icon">
    ...
    <div class="text-center">
        @if(@$data==='noDataFound')
            <div style="font-size: 20px;font-weight: bold;">No Data Found!</div>
        @else
        <div style="font-size: 20px;font-weight: bold;">No results found</div>
        @if(@$data==='remove_bottom_text')
        @else
            <div>Try different keywords or remove search filters</div>
            @endif
        @endif
    </div>
</div>
